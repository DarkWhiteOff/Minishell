...
SRC = src/main.c src/builtins/env.c src/exec/exec.c src/exec/exec0.c src/exec/exec2.c src/builtins/export.c src/builtins/export1.c src/builtins/export+=.c src/builtins/unset.c src/builtins/unset1.c src/tokens/tokens.c src/tokens/tokens_utils.c src/tokens/tokens_utils1.c src/builtins/echo.c src/builtins/cd.c src/builtins/cd1.c src/builtins/pwd.c src/exec/cmd_redirect.c src/utils/utils.c src/utils/utils1.c src/utils/free.c src/utils/signals.c src/utils/get_next_line.c src/heredoc.c
